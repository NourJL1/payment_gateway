...
public class WalletTransferServiceImpl implements WalletTransferService {
        ...
        public WalletToWalletTransferResponse transfer(WalletToWalletTransferRequest request) {
                ...
                WALLET feeWallet = walletRepo.findOneByWalIden(feeRule.getFruFeesWalletId().toString())
                ...
                WALLET vatWallet = walletRepo.findOneByWalIden(feeRule.getFruTvaWalletId().toString())
